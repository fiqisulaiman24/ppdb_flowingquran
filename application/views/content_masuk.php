...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body" style="border-radius: 50px;">
      ...
      <form action="<?= site_url('masuk/proses_masuk') ?>" method="post">
        <div class="input-group mb-3">
          <input type="text" name="username" class="form-control" placeholder="e.g. username">
      ...
      <p class="mb-1">
        <a href="<?= site_url('masuk/lupa_password')?>" class="text-success">Lupa password ?</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
